...
async function main(){
  ...
  try{
    ...
    for(const file of ['001_esquema.sql','002_sistemas_2016_2025.sql','003_catalogos_equivalencias.sql','004_importacion_pdf.sql','005_valores_catalogo_importados.sql','006_codigo_dictamen_origen.sql']){
